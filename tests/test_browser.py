...
def test_authenticated_dashboard_and_admin(system):
    ...
    with sync_playwright() as p:
        ...
        page.locator('#admin-user-form [name=email]').fill('viewer@example.test')
        page.locator('#admin-user-form [name=enabled]').check()
        ...
        page.locator("#profile-form [name=name]").fill("TimeBeacon Contributors")
